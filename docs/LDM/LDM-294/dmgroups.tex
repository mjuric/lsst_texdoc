...
The System engineering team looks after all aspect of system engineering. It is comprised of not only a System Engineer (\secref{role:sysengineer}) but also the Requirements Engineer (\secref{role:reqeng}, Software Architect (\secref{role:softarc}) and the Pipeline Scientist (\secref{role:pipe}).
