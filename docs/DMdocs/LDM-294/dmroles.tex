...
The product owner, usually a scientist, is responsible for the product quality and acceptance. 
...
The Pipeline Scientist should provide guidance and test criteria for the full pipeline including how QA is done on the products. 
\ldots
...
\subsection{System Architect \label{role:sysarc }}
