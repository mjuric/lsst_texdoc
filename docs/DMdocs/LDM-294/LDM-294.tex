...
\setDocTitle    [DM Charter]
                    {\color[rgb]{0.16,0.42,0.57} \sf Data Management Organization 
                    }
\setDocAuthor   {William O'Mullane, Mario Juric, Jeffrey P Kantor,  Tim Axelrod,  Roberta Allsman}                % the author(s) \setDocApprove  {LSST Project Oeefice}              % approval by ...
