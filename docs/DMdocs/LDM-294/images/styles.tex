...
\tikzstyle{ambox}=[rectangle, rounded corners=3pt, draw=red, top color=green!50!white, bottom
color=cyan, very thick, minimum height=10mm, inner sep=2pt, text centered, text width=18mm]

\tikzstyle{psbox}=[rectangle, rounded corners=3pt, draw=blue, top color=blue!50!white, bottom
