...
\begin{itemize}
  \item  No standard - no Overview I could find .
\begin{itemize}
  \item not nice to have tex/markdown/word others ?   
   \item did not find a document management plan for DM .. job of a documentalist  
   \item docushare  is the LSST repo but DM docs seem old (did find some from KT)
...
\frame {\frametitle{  LSST  DM docs } 
\begin{itemize}
  \item  LDTN-030 - ok for code documentation - 
	\begin{itemize}
	\item Provides document shards - no structure - how do you get a an old version (users will not get from git) .. 
