...
\frame {\frametitle{ Other processes ..}
Also in LDM-294:
	\begin{itemize}
	 \item Would like an open Risk approach - anyone can raise a risk (Tim working on that)	
	 \item Configuration control (change mangement, configuraiton item lists for deployments) 
	 \item Product assurance  and Scientific Validation 
	 \item Document management - in next slides
	\item \ldots
	\end{itemize}
